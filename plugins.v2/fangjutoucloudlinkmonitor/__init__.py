...
class FangjutouCloudLinkMonitor(_PluginBase):
    # 插件名称
    ...
    # 作者主页
    author_url = "https://github.com/abc123sm"
    # 插件配置项ID前缀
    plugin_config_prefix = "fangjutoucloudlinkmonitor_"
    # 加载顺序
    plugin_order = 2
    # 可使用的用户级别
    auth_level = 1
